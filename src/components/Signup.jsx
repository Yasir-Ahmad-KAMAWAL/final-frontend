...
const slides = [
  {
    ...
    desc: "Create your firm's workspace in minutes and start organizing projects the same day.",
  },
  {
    icon: (
      <svg viewBox="0 0 88 88" width="88" height="88" fill="none">
    ...
    desc: "Bring on developers, designers, and clients with role-based access from day one.",
  },
  {
    icon: (
      <svg viewBox="0 0 88 88" width="88" height="88" fill="none">
    ...
    desc: "Scale from one project to dozens without losing track of deadlines or deliverables.",
  },
];
