...
const HowItWorks = () => {
  return (
    <section
      id="how-it-works"
      className="py-24 px-6 md:px-[5%] bg-white dark:bg-[#090E1A] transition-colors duration-300"
    >
        ...
        <div className="grid gap-10 md:grid-cols-3">
          {steps.map((step, index) => (
            <div key={step.num} className="text-center px-4">
              <div
                className={`relative z-10 w-14 h-14 rounded-full border-2 flex items-center justify-center text-lg font-bold mx-auto mb-5 bg-white dark:bg-[#090E1A] ${
                  index === 2
