...
const roles = [
  ...
  },
  {
    label: "Tester",
    title: "QA Tester",
    desc: "Report bugs, verify resolved issues, and mark tests as passed or failed.",
    badgeClasses:
...
const Roles = () => {
  return (
    ...
    >
      ...
      <div className="mt-14 max-w-5xl mx-auto grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {roles.map((role) => (
          <div
            key={role.label}
            className="bg-white dark:bg-[#0D1526] border border-slate-200 dark:border-blue-900/20 rounded-2xl p-6 text-center hover:border-blue-400 dark:hover:border-blue-500/40 transition-all duration-200"
          >
            <span
